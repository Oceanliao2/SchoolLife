...
<body>
<div id="top_nav">
    <span id="here_area_bottom"><a href="/schooladmin/index.php/home/index/Tow" class="actBtn lsf">新增栏目</a></span><span id="here_area">当前位置：信息管理&nbsp;>&nbsp;信息发布管理</span>
</div>
            ...
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td align="center">
                                 <a href="javascript:" onclick="del(<?php echo ($T["id"]); ?>,'two');" >编辑</a>
                                 <a href="two_edit.html" >添加</a>
                              <a href="/schooladmin/index.php/home/index/deleAttr/id/<?php echo ($data["id"]); ?>/table/message_2">删除</a>
