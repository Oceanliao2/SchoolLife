...
<body>
<div id="top_nav">
    <span id="here_area_bottom"><a href="javascript:history.go(-1)" class="actBtn lsf">undo 返回</a></span><span id="here_area">当前位置：信息发布管理&nbsp;>&nbsp;失物招领</span>
</div>
<div id="top_nav_p"></div>



<form id="Formid" name="myForm" action="/schooladmin/index.php/home/index/two_edit/message_2/id/<?php echo $_GET['cid'];?>" method="post">
	<div id="container">
               ...
               <li>
                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     ...
                     <td width="10">&nbsp;</td>
                     <td><input type="text" name="message_tittle" id="message_tittle" value="<?php echo ($T["message_tittle"]); ?>"  class="ui_input_txt03" /></td>
                   </tr>
                   <tr>
                     <td align="right"><label for="describe">物品描述：</label></td>
                     <td>&nbsp;</td>
                     <td><textarea name="message_more" id="message_more" cols="45" class="ui_textarea_txt03"  rows="5"><?php echo ($T["message_more"]); ?></textarea></td>
                   </tr>
                   
                   <tr>
                     <td width="200" align="right"><label for="price">拾取地点：</label></td>
                     <td width="10">&nbsp;</td>
                     <td><input type="text" name="span_2" id="span_2"  value="<?php echo ($T["span_2"]); ?>" class="ui_input_txt02" /></td>
                   </tr>
                   <tr>
                     <td width="200" align="right"><label for="price">酬谢方式：</label></td>
                     <td width="10">&nbsp;</td>
                     <td><input type="text" name="span_3" id="span_3"  value="<?php echo ($T["span_3"]); ?>" class="ui_input_txt02" /></td>
                   </tr>
                    <tr>
                     <td width="200" align="right"><label for="price">物品价值：</label></td>
                     <td width="10">&nbsp;</td>
                     <td><input type="text" name="span_4" id="span_4"  value="<?php echo ($T["span_4"]); ?>" class="ui_input_txt02" /></td>
                   </tr>
                    <tr>
                     <td width="200" align="right"><label for="price">QQ：</label></td>
                     <td width="10">&nbsp;</td>
                     <td><input type="text" name="qq" id="qq"  value="<?php echo ($T["qq"]); ?>" class="ui_input_txt02" /></td>
                   </tr>
                    <tr>
                     <td width="200" align="right"><label for="price">电话：</label></td>
                     <td width="10">&nbsp;</td>
                     <td><input type="text" name="tel" id="tel"  value="<?php echo ($T["tel"]); ?>" class="ui_input_txt02" /></td>
                   </tr>
                   <tr>
