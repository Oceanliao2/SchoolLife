...
<body>
<div id="top_nav">
    <span id="here_area_bottom"><a href="javascript:history.go(-1)" class="actBtn lsf">undo 返回</a></span><span id="here_area">当前位置：信息发布管理&nbsp;>&nbsp;二手交易</span>
</div>
<div id="top_nav_p"></div>



<form id="Formid" name="myForm" action="/schooladmin/index.php/home/Common/edit/table/message_2/id/<?php echo $_GET['cid'];?>" method="post">
	<div id="container">
            ...
            <div class="formLab">
               <li>
                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                   ...
                   <tr>
                     <td width="200" align="right"><label for="price">价格：</label></td>
                     <td width="10">&nbsp;</td>
