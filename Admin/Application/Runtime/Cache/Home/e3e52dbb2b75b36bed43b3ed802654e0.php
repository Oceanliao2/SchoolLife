...
<script type="text/javascript" src="/scwelife/admin/Public/Jquery/Check.js"></script>
<link href="/scwelife/admin/Public/style/authority/basic_layout.css" rel="stylesheet" type="text/css">
<link href="/scwelife/admin/Public/style/authority/common_style.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/scwelife/admin/Public/scripts/authority/commonAll.js"></script>
<script type="text/javascript" src="/scwelife/admin/Public/scripts/fancybox/jquery.fancybox-1.3.4.js"></script>
<script type="text/javascript" src="/scwelife/admin/Public/scripts/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
<link rel="stylesheet" type="text/css" href="/scwelife/admin/Public/style/authority/jquery.fancybox-1.3.4.css" media="screen"></link>
<script type="text/javascript" src="/scwelife/admin/Public/scripts/artDialog/artDialog.js?skin=default"></script>
<link href="/scwelife/admin/Public/Font/LigatureSymbols/LigatureSymbols/style.css" rel="stylesheet" type="text/css" />
<style>
...
<script type="text/javascript">
	...
	function del(ID,TABLE){
		...
		if(confirm("您确定要删除吗？")){
			$.ajax({    
				url:'/scwelife/admin/index.php/home/index/Del', 
				type:'POST', 
				timeout:3000,   
				async:false,
...
<body>
<div id="top_nav">
    <span id="here_area_bottom"><a href="/scwelife/admin/index.php/home/index/Tow" class="actBtn lsf">新增栏目</a></span><span id="here_area">当前位置：信息管理&nbsp;>&nbsp;信息发布管理</span>
</div>
            ...
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td align="center">
                                 <a href="/scwelife/admin/index.php/home/index/two_edit<?php if($data['span_1'] == '失物招领'): ?>02<?php else: ?>01<?php endif; ?>/cid/<?php echo ($data["id"]); ?>" >编辑</a>
                              <a href="/scwelife/admin/index.php/home/index/deleAttr/id/<?php echo ($data["id"]); ?>/table/message_2">删除</a>
