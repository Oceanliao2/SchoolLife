...
/*ajax验证*/
  $(function(){ 
    $('input:button').click(function(){ 
      ...
      $.get('__URL__/login_pass',{username:$username,password:$password},function(data){ 
...
<!--......................................................................................-->
<div class="login">
<div class="title">登录&nbsp&nbsp·&nbsp&nbsp<a href="__APP__/User/add">注册</a></div>
<center>
    ...
    <ul>
        ...
        <input onkeyup="ValidateValue(this)" type="text" placeholder="邮箱" name="username" /><br/> </li>
        <li><span class="glyphicon glyphicon-lock"></span>
        <input onkeyup="ValidateValue(this)" type="password" placeholder="密码" name="password" onpaste="return false"/><br/> </li>
        <input class="submit" type="button" value="提交" /><br><br>
        <a href="__APP__/User/find_code">忘记密码</a>
    </ul>     
    </form> 
</center>    
</div> 
