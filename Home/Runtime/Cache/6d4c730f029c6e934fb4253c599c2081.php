   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    ...
    $(document).ready(function(){
     ...
     {    //user函数名 一定要和action中的第三个参数一致上面有
         var id = id;
            $.get('__URL__/find', {'p':id}, function(data){  //用get方法发送信息到UserAction中的user方法
    ...
    <div class="top">
      <center>
        ...
        <ul>
          ...
          <a href="__URL__/find.html"><li class="look" style="width:100px;">寻物启事</li></a>
...
<!--。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。-->
      ...
      <div class="new_tittle"><h2>全部寻物启事</h2></div>
      <center>
      <div class="new">
        <ul>
