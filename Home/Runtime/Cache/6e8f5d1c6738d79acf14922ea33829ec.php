...
<div id="body">
    <div class="top">
      <center>
        ...
        <ul>
          <a href="__APP__/School/community_add"><li class="look">分享话题</li></a>
          <a href="__APP__/School/essay_add"><li>分享文章</li></a>
          <a href="__APP__/School/video_add"><li>分享视频</li></a>
    ...
    <div class="crumbs">
      <center>
        ...
        <a href="#" ><span style="background-color:#CC3366">分享话题</span></a>
      </center>
    </div>

<!--表单............................................................-->
<center>
  <form method="post" action='__URL__/community_add_pass' enctype="multipart/form-data" id="form">
    <div class="inf">
      <div class="inf_left">
          <div id="del"></div>
          <div id="inf_left_top">
      ...
      <div class="inf_left_right">
        <center><input type="text" name="message_tittle" id="message_tittle" class="title" placeholder="标题" maxLength="40"></center>
        <textarea  name="message_more" id="message_more" id="message_more"></textarea>
        <input type="bUtton" value="提交" onclick="pass()" class="input"> 
