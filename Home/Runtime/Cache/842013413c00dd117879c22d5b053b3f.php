...
/*ajax分页*/
     ...
     {    //user函数名 一定要和action中的第三个参数一致上面有
         var id = id;
            $.get('__URL__/community', {'p':id}, function(data){  //用get方法发送信息到UserAction中的user方法
	...
	<div class="top">
      <center>
        ...
        <ul>
          ...
          <a href="__APP__/School/community" ><li  class="look">校园话题</li></a>
          ...
          <a href="#"><li style="width:80px">校园图库</li></a>
          <li class="user">
...
<center>
      <div class="part_new_tittle"><h2>校园话题</h2></div>
      <div class="inf">
      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="imf_more">
              <small style="color:#660033; font-weight:100">
                 赞<?php echo ($vo["good"]); ?> &nbsp
                 评论<?php echo ($vo["comment"]); ?>&nbsp
