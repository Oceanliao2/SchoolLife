...
<div id="body">
    ...
    <div class="crumbs">
      <center>
        ...
        <a href="#" ><span style="background-color:#CC3366">发布话题</span></a>
      </center>
    </div>

<!--表单............................................................-->
<center>
  <form method="post" action='__URL__/area_update_community_pass' enctype="multipart/form-data" id="form">
    <div class="inf">
      <div class="inf_left">
          <div id="del"></div>
          <div id="inf_left_top">
      ...
      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="inf_left_right" id ="inner">
        <center><input value="<?php echo ($vo["message_tittle"]); ?>" type="text" name="message_tittle" id="message_tittle" class="title" placeholder="标题" maxLength="20"></center>
        <textarea  name="message_more" id="message_more" id="message_more"><?php echo ($vo["message_more"]); ?></textarea>
