...
/*ajax分页*/
     ...
     {    //user函数名 一定要和action中的第三个参数一致上面有
         var id = id;
            $.get('__URL__/two', {'p':id}, function(data){  //用get方法发送信息到UserAction中的user方法
...
<div id="body">
    <div class="top">
      <center>
        ...
        <ul>
          ...
          <a href="__URL__/two.html"><li class="look" style="width:100px;">二手信息</li></a>
          <a href="__URL__/lose.html"><li>失物招领</li></a>
    ...
    <div class="crumbs" >
      <center>
        ...
        <a  href="#" style="color:#CC3D3D">二手信息发布</a>
      </center>
    </div>
    ...
    <div class="part_add">
      ...
      <div class="menu_more">
        ...
        <div style="position:relative;top:-35px;" class="part_add_button" id="part_add_button">发布</div>
        </a>
        <div class="menu">
...
<!--。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。。-->
      ...
      <div class="new_tittle"><h2>全部二手信息</h2></div>
      <center>
      <div class="new">
        <ul>
          ...
          <nobr><small><?php echo (subtext($vo['span_2'],8)); ?>&nbsp<?php echo (subtext($vo['span_3'],8)); ?><br>电话:<?php echo (subtext($vo["tel"],11)); ?> QQ:<?php echo (subtext($vo["qq"],11)); ?><br><br></small></nobr>
