    ...
    <div class="templatemo-flex-row">
      ...
      <div class="templatemo-sidebar" style="position:fixed">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            <li><a href="#" class="active"><i class="fa fa-home fa-fw"></i>浏览</a></li>
...
<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="message">
      ...
      function look(id)
      {
         window.open("__URL__/index4/id/"+id,"abcd","height=540,width=404");
      }
         
      </script>

      <button class="B_look" onclick="look(<?php echo ($vo["id"]); ?>)">预览</button>
      <a href="http://qr.liantu.com/api.php?text=http://www.shzlife.com/dzmp/index.php/Main/index4/id/<?php echo ($vo["id"]); ?>">
      <button class="B_two">二维码</button>
      </a>
      <a href="__URL__/del/id/<?php echo ($vo["id"]); ?>">
        <button class="B_delete">删除</button>
      </a>

      <a href="__URL__/update/id/<?php echo ($vo["id"]); ?>">
        <button class="B_two">修改</button>
      </a>
